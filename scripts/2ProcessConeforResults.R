# Post-process Conefor results run through shell
# Author: Wenxin Yang
# Date: Sept, 2022


root_folder <- 'C:/Users/wyang80/Desktop/CONN_MEASURE/data/Colombia/results'
setwd(root_folder)


conefor_folder = 'C:/Users/wyang80/Desktop/CONN_MEASURE/data/Colombia/conefor_results'

n_iter = 100

iters_result_path <- paste0(root_folder, '/Colombia_100iterations_April06.csv')
#iters_result_path <- paste0(root_folder, '/Colombia_results.csv')
...
#a = 95923.9 # Liberia
a = 1142648.24288 # Colombia
# according to the equation: ProtConn = 100 * ECA / AL
# so, ECA = ProtConn * AL / 100
iters_result$eca <- a*iters_result$protconn/100
write.table(iters_result, paste0(root_folder, '/Colombia_100iterations_April06_final.csv'), sep = ',')
