...
results_folder <- '/Users/wenxinyang/Desktop/ProtConn/results/STATES100KM'
d <- 100000
...
table_for_PA_nds <- paste(root_folder, '/STATE_attrib_table_PA_mexcanus_nds_july2021.csv', sep = "") # if generated from script, will be a txt file
table_for_PA_ds <- paste(root_folder, '/STATE_attrib_table_PA_mexcanus_final_july2021.csv', sep = "")
...
table_country_area <- paste(root_folder, '/STATE_area.txt', sep = "")

## Output files
outfile_all_results <- paste(results_folder,"/All_values_STATE_final_",'test',".txt", sep = "")
outfile_protconn_results <- paste(results_folder,"/ProtConn_results_STATE_final_",'test',".txt", sep = "")
